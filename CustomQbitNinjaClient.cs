...
namespace QBitNinja.Client
{
    ...
    public class CustomQBitNinjaClient
    {
        ...
        public CustomQBitNinjaClient(Network network)
        {
            if (network == null)
        ...
        public CustomQBitNinjaClient(string baseAddress, Network network = null)
            : this(new Uri(baseAddress, UriKind.Absolute), network)
        {

        }
        public CustomQBitNinjaClient(Uri baseAddress, Network network = null)
        {
            if (baseAddress == null)
        ...
        {
            return new HttpClient(innerHandler) {Timeout = TimeSpan.FromMinutes(3)};
        }
